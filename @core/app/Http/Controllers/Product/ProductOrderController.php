...
class ProductOrderController extends Controller
{
    public function product_checkout(Request $request){
        ...
        elseif ($request->selected_payment_gateway === 'paystack'){
        ...
        }elseif ($request->selected_payment_gateway === 'nimbbl'){
            ...
            $order_data = array(
                ...
                "user" => [
                    "mobile_number" =>$order_details->billing_phone,
                    "email" => $order_details->billing_email,
                    "first_name" => $order_details->billing_name,
                    "last_name" => $order_details->billing_name,
                ],
                'shipping_address' => [
                    'area' => $order_details->billing_town,
                    'city' => $order_details->billing_district,
                    'state' => $order_details->billing_country,
                    'pincode' => '400063',
