...
function render_payment_gateway_for_form($cash_on_delivery = false)
{
    ...
    $all_gateway = [
        'paypal', 'manual_payment', 'mollie', 'paytm', 'stripe', 'razorpay', 'flutterwave', 'paystack','nimbbl'
    ];
    $output .= '<ul>';
    if ($cash_on_delivery) {
    ...
    if ($nimbbl) {
        $output .= '<li data-gateway="nimbbl" ><div class="img-select">';
        // $output .= render_image_markup_by_attachment_id(get_static_option('cash_on_delivery_preview_logo'));
        $output .='<img src="/rahulgandhi/assets/uploads/media-uploader/nimbbl_logo.png" alt="nimbbl" width="100" height="60">';
        $output .= '</div></li>';
    }
...
function nimbbl_gateway()
{
    return \App\PaymentGateway\PaymentGatewaySetup::nimbbl();
}
