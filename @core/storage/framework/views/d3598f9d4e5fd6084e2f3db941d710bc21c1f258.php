            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="order-success-area">
                        <h1 class="title"><?php echo e(get_static_option('product_cancel_page_title')); ?></h1>
                        <p><?php echo e(get_static_option('product_cancel_page_description')); ?></p>
...
<?php echo $__env->make('frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\rahulgandhi\@core\resources\views/frontend/pages/products/product-cancel.blade.php ENDPATH**/ ?>